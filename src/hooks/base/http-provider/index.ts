...
interface IHttpProvider {
    interceptors: {
        ...
        onResponse: (res: AxiosResponse<any, any>) => AxiosResponse<any, any> | Promise<AxiosResponse<any, any>>
    }
}
...
export const useHttpProvider = (params?: IHttpProvider) => {
    ...
    React.useEffect(() => {
        ...
        if (!params) return;
        const {interceptors: {onRequest, onResponse}} = params;
        httpProvider.interceptors.request.use((reqConfig: AxiosRequestConfig<any>) => {
